...
(function() {
    ...
    estilo.innerHTML = `
        ...
        .foto-casal-global { width: 120px; height: 120px; border-radius: 50%; object-fit: cover; border: 4px solid white; margin-bottom: 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.2); }
